...
return(
  <div>
     ...
     <table className='table' style={{borderRadius:"10px", backgroundColor:"#1f1f1f", color:"#f5f5f5"}}>
      <tr style={{backgroundColor:"#2c2c2c", color:"#f5f5f5"}}>
      ...
      <th style={{color: "#f5f5f5"}}>State</th>
      <th>
